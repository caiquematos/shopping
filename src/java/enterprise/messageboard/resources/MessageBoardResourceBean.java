...
public class MessageBoardResourceBean {
    ...
    @GET
    @Produces({MediaType.APPLICATION_JSON,"text/html"})
    public String getProducts(){
        return singleton.retrieveProducts();
    }
        
    @Path("items/{user_id}")
    @GET
    @Produces({MediaType.APPLICATION_JSON,"text/html"})
    public String getItems(@PathParam("user_id") int user_id) throws NotFoundException{
        
         String json_items = singleton.getItemsByUserId(user_id);
    ...
    public String addUser(String newUserJson) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        return singleton.addUser(newUserJson);
    }
    ...
    @POST
    @Produces({"application/xml", "text/html"})
    public String addItemToCart(@QueryParam("productId") int productId,
            @PathParam("quantity") int quantity,
            @PathParam("userId") int userId) {
        return singleton.addItemToCart(productId,quantity, userId);
    }
    ...
    public String login(String loginJson) {
        ...
        return singleton.doLogin(loginJson);
    }
